...
u16 Get_Adc(u8 ch)   
{
	...
	ADC_RegularChannelConfig(ADC1, ch, 1, ADC_SampleTime_239Cycles5  );	//ADC1,ADC通道,采样时间为--周期	  			    
...
//	int bat; char ad[5];
	...
	if(BatteryVol < 3.2)
		OLED_DrawBMP(111,0,127,1,(uint8_t *)Bat1_16x8);//显示电量1
	else if(BatteryVol < 3.7)
		OLED_DrawBMP(111,0,127,1,(uint8_t *)Bat2_16x8);//显示电量2
	else if(BatteryVol < 4)
		OLED_DrawBMP(111,0,127,1,(uint8_t *)Bat3_16x8);//显示电量3
	else
		OLED_DrawBMP(111,0,127,1,(uint8_t *)Bat4_16x8);//显示电量4
